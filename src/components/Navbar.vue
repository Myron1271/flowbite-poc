  ...
  <nav class="bg-gray-100 border-gray-200 dark:bg-gray-900">
    <div class="container mx-auto flex flex-wrap items-center justify-between p-4">
      ...
      <div class="hidden w-full md:block md:w-auto" id="navbar-default">
        <ul class="font-medium flex flex-col md:flex-row p-4 md:p-0 mt-4 md:mt-0 border border-gray-100 rounded-lg bg-gray-50 md:border-0 md:bg-transparent md:space-x-8 rtl:space-x-reverse dark:bg-gray-800 md:dark:bg-transparent dark:border-gray-700">
          <li>
